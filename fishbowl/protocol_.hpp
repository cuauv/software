...
template<typename R, typename W>
camera_box& protocol<R, W>::get_camera(camera_id id) throw(std::invalid_argument)
{
...
template<typename R, typename W>
void protocol<R, W>::remove_camera(camera_id id) throw(std::invalid_argument)
{
...
template<typename R, typename W>
void protocol<R, W>::remove_estream(estream_id id) throw(std::invalid_argument)
{
...
template<typename R, typename W>
void protocol<R, W>::remove_ctrigger(trigger_id id) throw(std::invalid_argument)
{
...
template<typename R, typename W>
void protocol<R, W>::remove_cstrigger(trigger_id id) throw(std::invalid_argument)
{
...
template<typename R, typename W>
void protocol<R, W>::remove_ptrigger(trigger_id id) throw(std::invalid_argument)
{
...
template<typename R, typename W>
void protocol<R, W>::remove_cstream(cstream_id id) throw(std::invalid_argument)
{
...
template<typename R>
static void assert_rd_ended(R& rd) throw(malformed_exn)
{
    rd.end();
    if (rd.failed()) {
        throw malformed_exn();
...
static bool is_eattr(uint8_t attr)
{
    return attr <= 5;
}
